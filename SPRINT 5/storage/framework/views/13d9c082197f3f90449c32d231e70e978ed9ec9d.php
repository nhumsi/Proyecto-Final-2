					...
					<form class="access-form-registro" action="/ABM/editar" method="post" enctype="multipart/form-data">
							...
							<div class="input-group mb-3">
								<div class="input-group-prepend">
								    ...
								    <input type="text" class="form-control"  name="color" id="color" value="<?php echo e($producto->color); ?>">
							...
							<input type="text" id="precio" name="precio" value="<?php echo e($producto->precio); ?>">
								</div>
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">Stock:</span>
                    </div>
				<input type="text" id="stock" name="stock"  value="<?php echo e($producto->stock); ?>">
                  </div>
                <div class="field-group">
                        <p for="msg">Descripción:</p>
				<textarea name="Descripcion" id="descripcion" rows="8" cols="40" value="<?php echo e($producto->descripcion); ?>"></textarea>
                </div>
                <br>
...
<?php /**PATH E:\DH\Github\Proyecto-Final-2\SPRINT 5\resources\views/detalle.blade.php ENDPATH**/ ?>