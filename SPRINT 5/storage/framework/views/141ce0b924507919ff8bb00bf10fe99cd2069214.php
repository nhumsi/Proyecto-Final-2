						...
						<form class="access-form-registro" action="/ABM/guardar" method="post" enctype="multipart/form-data">
							...
							<div class="input-group mb-3">
								<div class="input-group-prepend">
								    ...
								    <input type="text" class="form-control" placeholder="Color" name="color" id="color" value="<?php echo e(old("color")); ?>">
...
<?php /**PATH E:\DH\Github\Proyecto-Final-2\SPRINT 5\resources\views/ABM.blade.php ENDPATH**/ ?>