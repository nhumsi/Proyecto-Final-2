  ...
  <body>
    <div class="container"> <!-- Contenedor ppal -->
      ...
      <main class="cd-main-content">
        ...
        <div class="col-md-7 col-sm-7 col-xs-12 col-lg-12">
        ...
        <div class="container-fluid" style="padding-left:0; padding-right:0; background-color: rgba(255, 255, 255, 0.8); padding-top:40px;">
      ...
      <footer class="container">
        <div class="contacto">
          <p>Shanti Insumos</p>
          <p>Telefono: 3815545454</p>
          <p>Direccion: Cordoba 656</p>
          <p>Email: shantiinsumos@gmail.com</p>
        </div>
      </footer>
