	...
	<body class="page-template-default page page-id-6 custom-background wp-custom-logo woocommerce-cart woocommerce-page woocommerce-no-js right-sidebar woocommerce-active">
        ...
        <a id="cd-menu-trigger" href=""><span class="cd-menu-text">Menu</span><span class="cd-menu-icon"></span></a>
			...
			<div id="content" class="site-content" tabindex="-1">
				...
				<nav class="woocommerce-breadcrumb"><a href="#">Inicio</a>&nbsp;&#47;&nbsp;Carrito</nav>
				...
				<main id="main" class="site-main" role="main">
						...
						<div class="woocommerce">
							<form class="woocommerce-cart-form" action="/carrito" method="post">
								...
								<tbody>
									...
									<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>450.00</span>						</td>
								...
								<td class="product-quantity" data-title="Cantidad">
									<div class="quantity">
										<label class="screen-reader-text" for="quantity_5dede930c8fe8">Cantidad</label>
										<input
											type="number"
											id="quantity_5dede930c8fe8"
											class="input-text qty text"
											step="1"
											min="0"
											max=""
											name="cart[202cb962ac59075b964b07152d234b70][qty]"
											value="1"
											title="Cantidad"
											size="4"
											pattern="[0-9]*"
											inputmode="numeric"
											aria-labelledby="ALMOHADA TERMICA cantidad" />
									</div>
								</td>

								<td class="product-subtotal" data-title="Total">
									<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>620.00</span>						</td>
							</tr>
					...
					<tr>
						<td colspan="6" class="actions">
													...
													<div class="coupon">
									<label for="coupon_code">Cupón:</label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="Código de cupón" /> <button type="submit" class="button" name="apply_coupon" value="Aplicar cupón">Aplicar cupón</button>
															</div>
		...
		<div class="cart-collaterals">
			...
			<table cellspacing="0" class="shop_table shop_table_responsive">
				...
				<tr class="cart-subtotal">
					<th>Subtotal</th>
					<td data-title="Subtotal"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>1,070.00</span></td>
				</tr>
			...
			<td data-title="Envío">
				...
				<tr class="order-total">
					<th>Total</th>
					<td data-title="Total"><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>1,070.00</span></strong> </td>
				</tr>
			</table>

			<div class="wc-proceed-to-checkout">

				<a href="https://yogayfitness.com.ar/compras/finalizar-compra/" class="checkout-button button alt wc-forward">
					Finalizar compra</a>
					</div>
				</div>
				</div>
		...
		<div id="secondary" class="widget-area" role="complementary">
			...
			<footer id="colophon" class="site-footer" role="contentinfo">
				<div class="col-full">
							...
							<div class="site-info">
					&copy; Yoga y Fitness 2019						<br /> Storefront diseñado por <a href="http://www.woocommerce.com" title="WooCommerce - The Best eCommerce Platform for WordPress" rel="author">WooCommerce</a>.					</div><!-- .site-info -->
						<div class="storefront-handheld-footer-bar">
					<ul class="columns-3">
											<li class="my-account">
								<a href="https://yogayfitness.com.ar/compras/mi-cuenta/">Mi cuenta</a>					</li>
											<li class="search">
								<a href="">Buscar</a>			<div class="site-search">
						<div class="widget woocommerce widget_product_search"><form role="search" method="get" class="woocommerce-product-search" action="https://yogayfitness.com.ar/compras/">
			...
			<input type="hidden" name="post_type" value="product" />
											...
											<li class="cart">
											<a class="footer-cart-contents" href="https://yogayfitness.com.ar/compras/carrito/" title="Ver carrito de la compra">
