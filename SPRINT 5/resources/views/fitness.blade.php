  ...
  <body>
        ...
        <div id="primary" class="content-area">
          ...
          <ul class="products columns-3">
            ...
            <li class="post-1512 product type-product status-publish has-post-thumbnail product_cat-accesorios product_cat-yoga product_cat-otros-productos last instock taxable shipping-taxable purchasable product-type-simple">
              <a href="#" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                <img width="300" height="300" src="css/img/fisiobalon.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail wp-post-image" alt="" sizes="(max-width: 300px) 100vw, 300px" />
                <h2 class="woocommerce-loop-product__title">FISIOBALON</h2>
